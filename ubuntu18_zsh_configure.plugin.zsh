...
if [ -d ${HOME}/.Qt6 ]; then
  ...
  QT_INCLUDE_DIRS=$(echo $HOME/.Qt6/6.8.1/gcc_64/include/*(/) | tr ' ' ':' | sed 's/:$//')
  export C_INCLUDE_PATH=${C_INCLUDE_PATH}:$HOME/.Qt6/6.8.1/gcc_64/include:$QT_INCLUDE_DIRS # Load at compile time
